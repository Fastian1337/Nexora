  ...
  return (
    <div className="w-full max-w-md space-y-8 rounded-2xl border border-border/50 bg-card/40 p-8 backdrop-blur-xl shadow-2xl">
      <div className="text-center space-y-2">
        ...
        <p className="text-sm text-muted-foreground">Sign in to manage your AI Employees</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="space-y-1">
          ...
          <input
            ...
            className="w-full px-4 py-2.5 rounded-lg border border-border bg-background/50 focus:outline-none focus:ring-2 focus:ring-blue-500/40 text-sm transition-all"
        ...
        <div className="flex items-center justify-between">
          <label className="flex items-center gap-2 cursor-pointer select-none">
            <input
              ...
              className="rounded border-border bg-background/50 text-blue-600 focus:ring-blue-500/30"
            />
        ...
        <button
          type="submit"
          disabled={submitting}
          className="w-full py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-semibold text-sm rounded-lg transition-all shadow-lg shadow-blue-500/25 disabled:opacity-50 cursor-pointer"
        >
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-6 py-12">
      ...
      <React.Suspense fallback={
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <p className="text-sm font-medium text-muted-foreground font-mono">Loading login form...</p>
        </div>
      }>
        <LoginForm />
      </React.Suspense>
